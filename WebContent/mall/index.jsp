...
<script src="/Art/mall/js/index.js"></script>
<title>艺术品定制网站</title>
</head>
<body>
<div class="mobile">
	...
	<div id="content">
		<div class="top w">
	        ...
	        <div class="m_nav">
	        	<a onClick="newsList()"><img src="/Art/mall/images/news.png"><span>艺术资讯</span></a>
	            <a onClick="artMall()"><img src="/Art/mall/images/mall.png"><span>艺术商城</span></a>
	            <a href="javascript:void(0);" id="msg_artshop"><img src="/Art/mall/images/message.png"><span>我的消息</span></a>
	            <a onClick="shop()"><img src="/Art/mall/images/shop.png"><span>我的店铺</span></a>
	            <a onClick="favorite()"><img src="/Art/mall/images/favorite.png"><span>我的收藏</span></a>
	            <a href="javascript:void(0);" id="msg_artmsg"><img src="/Art/mall/images/cart.png"><span>购物车</span></a>
	            <a onClick="order()"><img src="/Art/mall/images/order.png"><span>我的订单</span></a>
	            <a onClick="person()"><img src="/Art/mall/images/person.png"><span>个人中心</span></a>
	        </div>
